...
function displayPics(){
  ...
  // changing rando's 'var' to 'let' changed the scope of the variable to only be known within the 'while' loop that it was declared in.
  // while 'var' is globally used within the function
  console.log(viewed)
